                    ...
                    <div id="nav-utilities" className="gap-[1rem] justify-center items-center absolute right-0
                        ...
                        <div className="hover:cursor-pointer">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                className="fill-white hover:fill-primary transition-hover:fill duration-800"
                            >
                        ...
                        <div className="hover:cursor-pointer">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                className="fill-white hover:fill-primary transition-fill duration-800"
                            >
                        ...
                        <div className="hover:cursor-pointer">
                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24"
                                className="fill-primary stroke-white hover:stroke-primary transition-fill duration-800"
                            >
