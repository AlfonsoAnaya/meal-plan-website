function WelcomeScreen() {
    return (
        <section className="todays-recipe-section flex flex-col justify-center items-center bg-[#c0e9ff]">
            
                <div className="h-[500px] flex flex-row justify-center items-strech w-[95%] max-w-[1200px] mt-12 mb-12 ">
                    <div className="w-[40%] flex flex-wrap gap-4 justify-center items-center">
                        <img className="block object-cover w-[100%] h-[100%] object-center rounded-[30px]" 
                        src="./img/recipes/00004.jpg" 
                        alt="un plato con dos tacos de carne, guacamole y pico de gallo"/>
                    </div>
                    <div className="w-[60%] pl-4 flex flex-col justify-center items-left">
